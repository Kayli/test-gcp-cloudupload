...
def test_post_uploads_returns_upload_url(api_context) -> None:
...
def test_post_uploads_without_required_fields_returns_400(api_context) -> None:
    resp = api_context.post(
        f"{APP_URL}/uploads",
        headers=_JSON_HEADERS,
        data=json.dumps({}),
...
def test_get_files_download_returns_download_url(api_context) -> None:
